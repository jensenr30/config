...
screen -S "ytda" -d -m bash -c 'cd /s/music/download; yt-continuous-download-audio; exec bash'
screen -S "ytdv" -d -m bash -c 'cd /s/youtube; yt-continuous-download-video; exec bash'
