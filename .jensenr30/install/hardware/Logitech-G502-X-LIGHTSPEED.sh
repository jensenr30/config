...
ratbagctl "$DEV" profile 0 resolution active set 2
ratbagctl "$DEV" profile 0 resolution default set 2
...
# NOTE: the "button numbers" do not match the button numbers seen on the buttons of the mouse.
ratbagctl "$DEV" button 4 action set button 4
ratbagctl "$DEV" button 5 action set button 5
ratbagctl "$DEV" button 6 action set button 8
ratbagctl "$DEV" button 7 action set button 7
ratbagctl "$DEV" button 8 action set special resolution-cycle-up
ratbagctl "$DEV" button 9 action set macro +KEY_RIGHTALT +KEY_RIGHTSHIFT +KEY_I -KEY_I -KEY_RIGHTALT -KEY_RIGHTSHIFT
ratbagctl "$DEV" button 10 action set macro +KEY_RIGHTCTRL +KEY_RIGHTSHIFT +KEY_F -KEY_F -KEY_RIGHTCTRL -KEY_RIGHTSHIFT
